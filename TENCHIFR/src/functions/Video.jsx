function Video({ activeMode, setActiveMode, setFiles, darkMode }){
    function handleVideoChange(event){
        setFiles(Array.from(event.target.files));
        setActiveMode("video");
    }

    const isActive = activeMode === "video";
    ...
    return (
        <>
            ...
            >
                ...
                <span className="text-[11px] sm:text-xs md:text-sm font-medium">Video</span>
            </button>
        </>
    );
}
